...
4) Получить список всех обсерваторий и их устройств в базе данных в JSON формате 
реквест по адресу http://host:8001/get-all-obs/ с Bearer Token в headers 'Authorization'
ответ - список обсерваторий в JSON формате, название обсерватории - ключ, список устройств - по ключу
{
    "GC0": [
        "POS1",
        "POS2"
